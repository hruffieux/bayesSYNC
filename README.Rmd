...
* representing high-dimensional curves using a small number of FPCA expansions, which arise from underlying latent factors;
...
* *Variable-specific loadings*: estimation of loadings for each variable that contributes to the FPCA expansions, providing insights into how latent factors influence subsets of variables.
...
Salima Jaoua (University of Zürich, Switzerland), Daniel Temko \& Hélène Ruffieux (University of Cambridge, UK).
